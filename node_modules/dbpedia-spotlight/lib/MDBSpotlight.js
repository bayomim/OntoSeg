...
exports.annotate = function (input, cb, err) {
    ...
    var default_endpoints={
      ...
      "german"     : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2226',confidence:0,support:0},
      "dutch"      : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2232',confidence:0,support:0},
      "hungarian"  : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2229',confidence:0,support:0},
      "french"     : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2225',confidence:0,support:0},
      "portuguese" : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2228',confidence:0,support:0},
      "italian"    : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2230',confidence:0,support:0},
      "rusian"     : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2227',confidence:0,support:0},
      "turkish"    : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2235',confidence:0,support:0},
      "spanish"    : {host:'spotlight.sztaki.hu', path:'/rest/annotate', port:'2231',confidence:0,support:0}
    }
    ...
    // bayomim 16/3/2015  --  2.25pm
   /*
    var url = 'http://spotlight.sztaki.hu:2222/rest/annotate?text=' + encodeURI(input);
   var tt =  request.get(url, {
        json: true,
